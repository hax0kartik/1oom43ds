...
/* -------------------------------------------------------------------------- */
 ...
 uint16_t lbxfont_plotchar_1x(char c, int maxh, uint8_t *buf, uint16_t pitch)
{
 ...
 uint16_t lbxfont_plotchar_nx(char c, int maxh, uint8_t *buf, uint16_t pitch, int scale)
{
    uint8_t char_w = lbxfontdata[0x4a + c];
    uint16_t gap_w = lbxfontdata[0x48];
    uint16_t w = char_w + gap_w;
 ...
 uint16_t lbxfont_plotchar(char c, int maxh, uint8_t *buf, uint16_t pitch, int scale)
{
    if (c < 0x20) {
        return 0;
    }
 ...
 int lbxfont_print_char_ret_x(int x, int y, char c, int maxy, uint16_t pitch, int scale)
{
 ...
 void lbxfont_plotchar_limit(int x, int y, char c, int xskip, int char_w, int yskip, int char_h, uint16_t pitch, int scale)
{
    uint16_t si = GET_LE_16(&lbxfontdata[0xaa + c * 2]);
 ...
 int lbxfont_print_char_ret_x_limit(int x, int y, char c, int lx0, int ly0, int lx1, int ly1, uint16_t pitch, int scale)
{
    c -= 0x20;
    if ((c < 0) || (c > 0x5e)) {
        return x;
...
int lbxfont_print_str_do(int x, int y, const char *str, bool change_color, int w, int maxy, uint16_t pitch, int scale)
{
 ...
 int lbxfont_print_str_limit_do(int x, int y, const char *str, bool change_color, int lx0, int ly0, int lx1, int ly1, uint16_t pitch, int scale)
{
 ...
 int lbxfont_print_str_normal_do(int x, int y, const char *str, int w, int maxy, uint16_t pitch, int scale)
{
    uint16_t v2;
    v2 = lbxfontdata[0x12];
    if (v2 != 0) {
 ...
 int lbxfont_print_str_normal_do_w0(int x, int y, const char *str, int w, int maxy, uint16_t pitch, int scale)
{
    if (w < 0) {
        w = 0;
    }
 ...
 void lbxfont_split_str(int x, int y, int maxw, const char *str, split_str_t *s, uint16_t maxy)
{
...
int lbxfont_calc_str_width(const char *s)
{
    int gap_w = (int)lbxfontdata[0x48];
    int w = 0;
    char *str = (char *)s;
    char c;
    while (1) {
...
int lbxfont_print_str_center(int x, int y, const char *str, uint16_t pitch, int scale)
{
    ...
    int res = lbxfont_print_str_normal(x - (w/2), y, str, pitch, scale);
    return res;
}
